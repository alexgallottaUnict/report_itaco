...
la sua semantica, tramite metodi chiamati sull'oggetto ScrittoreTarget. Per
esempio il nodo Somma definisce il metodo in questo modo:
\begin{verbatim}
public void scriviCodice(ScrittoreTarget sc) throws EccezioneSemantica {
